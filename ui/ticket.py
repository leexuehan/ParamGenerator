...
class Ui_Ticket_Dialog(object):
    def setupUi(self, Ticket_Dialog):
        ...
        self.ticket_name_content.setGeometry(QtCore.QRect(170, 60, 161, 21))
        ...
        self.ticket_price_label_2.setGeometry(QtCore.QRect(80, 150, 91, 16))
        self.ticket_price_label_2.setObjectName("ticket_price_label_2")
        self.ticket_price_content_2 = QtWidgets.QTextEdit(Ticket_Dialog)
        self.ticket_price_content_2.setGeometry(QtCore.QRect(170, 140, 71, 31))
        self.ticket_price_content_2.setObjectName("ticket_price_content_2")
        self.ticket_price_label_3 = QtWidgets.QLabel(Ticket_Dialog)
        self.ticket_price_label_3.setGeometry(QtCore.QRect(260, 110, 81, 16))
        self.ticket_price_label_3.setObjectName("ticket_price_label_3")
        self.comboBox = QtWidgets.QComboBox(Ticket_Dialog)
        self.comboBox.setGeometry(QtCore.QRect(380, 110, 69, 22))
        self.comboBox.setObjectName("comboBox")
        self.ticket_price_label_4 = QtWidgets.QLabel(Ticket_Dialog)
        self.ticket_price_label_4.setGeometry(QtCore.QRect(260, 150, 81, 16))
        self.ticket_price_label_4.setObjectName("ticket_price_label_4")
        self.comboBox_2 = QtWidgets.QComboBox(Ticket_Dialog)
        self.comboBox_2.setGeometry(QtCore.QRect(380, 150, 69, 22))
